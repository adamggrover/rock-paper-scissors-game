...
})({"eQ8a3":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a08f81f84fd4ce8f";
"use strict";
...
},{}],"fUqB3":[function(require,module,exports) {
var global = arguments[3];
// modules are defined as an array
// [ module function, map of requires ]
//
...
(function(modules, entry, mainEntry, parcelRequireName, globalName) {
    ...
    "hklly": [
        function(require, module1, exports) {
            ...
            var HMR_SECURE = false;
            var HMR_ENV_HASH = "d6ea1d42532a7575";
            module1.bundle.HMR_BUNDLE_ID = "fe4256060641b553";
            "use strict";
            /* global HMR_HOST, HMR_PORT, HMR_ENV_HASH, HMR_SECURE, chrome, browser, __parcel__import__, __parcel__importScripts__, ServiceWorkerGlobalScope */ /*::
import type {
  HMRAsset,
...
${frame.code}`;
    ...
    "bNKaB": [
        function(require, module1, exports) {
            ...
            function setStartValues() {
                ...
                userChoiceImg.src = _questionPngDefault.default;
                computerChoiceImg.src = _questionPngDefault.default;
                // reset player scores
                userScore = 0;
                computerScore = 0;
            ...
            function game() {
                ...
                function userPlay(userChoice) {
                    ...
                    switch(userChoice){
                        case "rock":
                            userChoiceImg.src = _rockPngDefault.default;
                            break;
                        case "paper":
                            userChoiceImg.src = _paperPngDefault.default;
                            break;
                        case "scissors":
                            userChoiceImg.src = _scissorsPngDefault.default;
                            break;
                        default:
                            userChoiceImg.src = _questionPngDefault.default;
                    }
                    ...
                    switch(computerSelection){
                        case "rock":
                            computerChoiceImg.src = _rockPngDefault.default;
                            break;
                        case "paper":
                            computerChoiceImg.src = _paperPngDefault.default;
                            break;
                        case "scissors":
                            computerChoiceImg.src = _scissorsPngDefault.default;
                            break;
                        default:
                            computerChoiceImg.src = _questionPngDefault.default;
                    }
        ...
        {
            "./assets/icons/rock.png": "5j96T",
            "./assets/icons/paper.png": "8WSrg",
            "./assets/icons/scissors.png": "akPIr",
            "./assets/icons/question.png": "lMj2h",
            "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3"
        }
    ],
    "5j96T": [
        function(require, module1, exports) {
            module1.exports = require("619baeae74b388fa").getBundleURL("lPpKD") + "rock.d83ea0b4.png" + "?" + Date.now();
        },
        {
            "619baeae74b388fa": "lgJ39"
        }
    ],
    "lgJ39": [
        function(require, module1, exports) {
    ...
    "8WSrg": [
        function(require, module1, exports) {
            module1.exports = require("95af7e90ff5602ea").getBundleURL("lPpKD") + "paper.9e961607.png" + "?" + Date.now();
        },
        {
            "95af7e90ff5602ea": "lgJ39"
        }
    ],
    "akPIr": [
        function(require, module1, exports) {
            module1.exports = require("72e53d192f5eb5d1").getBundleURL("lPpKD") + "scissors.68e75d14.png" + "?" + Date.now();
        },
        {
            "72e53d192f5eb5d1": "lgJ39"
        }
    ],
    "lMj2h": [
        function(require, module1, exports) {
            module1.exports = require("52fbe554d07ddad3").getBundleURL("lPpKD") + "question.fb1d66bc.png" + "?" + Date.now();
        },
        {
            "52fbe554d07ddad3": "lgJ39"
        }
    ],
    "gkKU3": [
        function(require, module1, exports) {
    ...
    "hklly",
    "bNKaB"
], "bNKaB", "parcelRequireee27");

},{}]},["eQ8a3","fUqB3"], "fUqB3", "parcelRequireee27")

//# sourceMappingURL=index.4fd4ce8f.js.map
